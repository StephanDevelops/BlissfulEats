            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="<?php echo e(url('/home', Auth::user()->id)); ?>" class="active">Home</a></li>
...
<?php endif; ?>
    ...
    <?php $__currentLoopData = $data2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr align="center" style="position: relative; top: -60px; right: -360px;">
                <td>
                    <a href="<?php echo e(url('/remove', $data2->id)); ?>" class="btn btn-warning btn-sm" style="margin-right: 25px;">Remove</a>
                 </td>
            </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div id="appear" align="center" style="padding: 10px; display: none;">
            ...
            <div style="padding: 10px;">
                <input style="background-color: green;" class="btn btn-success" type="submit"  value="Confirm Order">
                <button id="close" type="button" class="btn btn-danger" style="background-color: rgb(220, 53, 69)">Close</button>
            </div>
        </div>
        </form>
    </div>
...
<?php /**PATH /Users/stephan/Documents/restaurant/resources/views/showcart.blade.php ENDPATH**/ ?>