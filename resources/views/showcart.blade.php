  ...
  <head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="https://blissfuleats.online" class="logo">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="{{url('/home', Auth::user()->id)}}" class="active">Home</a></li>
    ...
    @foreach($data2 as $data2)
            ...
            <tr align="center" style="position: relative; top: -60px; right: -360px;">
                <td>
                    <a href="{{url('/remove', $data2->id)}}" class="btn btn-warning btn-sm" style="margin-right: 25px;">Remove</a>
                 </td>
            </tr>
    @endforeach
